...
{
public double GetMovimientoTotalMesAnyo (int p_mes_movimiento, int p_anyo_movimiento, IManagerGenNHibernate.Enumerated.IManager.TipoMovimientoEnum p_tipomovimiento)
{
