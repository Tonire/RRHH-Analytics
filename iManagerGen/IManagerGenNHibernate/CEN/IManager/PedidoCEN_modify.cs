...
{
public void Modify (int p_Pedido_OID, IManagerGenNHibernate.Enumerated.IManager.EstadoPedidoEnum p_estado, Nullable<DateTime> p_fechaRealizacion, Nullable<DateTime> p_fechaConfirmacion, Nullable<DateTime> p_fechaCancelacion)
{
